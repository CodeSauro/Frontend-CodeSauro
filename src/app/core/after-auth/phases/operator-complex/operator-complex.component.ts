...
@Component({
  ...
  templateUrl: './operator-complex.component.html',
  styleUrl: './operator-complex.component.scss'
})
export class OperatorComplexComponent implements OnInit {
