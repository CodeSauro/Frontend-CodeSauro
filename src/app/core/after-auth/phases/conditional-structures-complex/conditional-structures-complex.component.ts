...
@Component({
  selector: 'app-conditional-structures-complex',
  standalone: true,
  imports: [
  ...
  templateUrl: './conditional-structures-complex.component.html',
  styleUrl: './conditional-structures-complex.component.scss'
})
export class ConditionalStructuresComplexComponent implements OnInit {
