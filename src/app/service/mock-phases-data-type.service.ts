  ...
  getMockData() {
    return [
      ...
      },
      {
        ...
        explaining_phase_page_1: "em breve...",
        number_of_pages_phases: 1,
        variables_page_1: ["else", "if", "else if", "em breve..."],
        correct_answers_page_1_ORDEM_CORRETA: ["em breve...", "else if", "else", "if"],
        number_of_pages_questions: 1,
        knowledge_validation_question: "em breve...",
        knowledge_validation_answers: ["em breve...", "em breve...", "em breve...", "em breve..."],
        knowledge_validation_correct_answer: "em breve...",
